...
public sealed class NavigationTests
{
    ...
    public void NavigationTest()
    {
        ...
        Assert.AreEqual(_navigationService.CurrentRoute, route1);
        Assert.IsFalse(_navigationService.CanGoBack);

        NavigationRoute route2 = new("test_route_2");
        object? parameter2 = null;
        _navigationService.Navigate(route2, parameter2);
        Assert.AreEqual(_navigationService.CurrentRoute, route2);
        ...
        Assert.IsFalse(_navigationService.CanGoBack);
        Assert.AreEqual(_navigationService.CurrentRoute, route3);
    }
}
