...
public sealed class AddDrawableCommand : IImageEditCommand, IResolutionAwareImageEditCommand
{
    ...
    {
        if (!session.Drawables.Any(drawable => ReferenceEquals(drawable, _drawable)))
        {
