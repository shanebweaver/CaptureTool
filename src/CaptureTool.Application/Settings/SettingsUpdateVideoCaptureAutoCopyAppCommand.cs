...
internal class SettingsUpdateVideoCaptureAutoCopyAppCommand : ISettingsUpdateVideoCaptureAutoCopyAppCommand
{
    private readonly ISettingsService _settingsService;

    public SettingsUpdateVideoCaptureAutoCopyAppCommand(ISettingsService settingsService)
    {
