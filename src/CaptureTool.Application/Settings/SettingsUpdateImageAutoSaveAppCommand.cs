...
internal class SettingsUpdateImageAutoSaveAppCommand : ISettingsUpdateImageAutoSaveAppCommand
{
    private readonly ISettingsService _settingsService;
    public SettingsUpdateImageAutoSaveAppCommand(ISettingsService settingsService)
    {
