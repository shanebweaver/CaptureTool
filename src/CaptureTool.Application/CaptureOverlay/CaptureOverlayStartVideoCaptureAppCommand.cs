...
public sealed partial class CaptureOverlayStartVideoCaptureAppCommand : ICaptureOverlayStartVideoCaptureAppCommand
{
    private readonly INavigationService _navigationService;
    private readonly IAppNavigation _appNavigation;
    private readonly IVideoCaptureHandler _videoCaptureHandler;

    public CaptureOverlayStartVideoCaptureAppCommand(
