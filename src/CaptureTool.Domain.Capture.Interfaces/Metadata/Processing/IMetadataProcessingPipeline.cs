...
/// <summary>
/// Configurable pipeline that runs registered processors over raw metadata
/// and produces a <see cref="RefinedMetadataFile"/> suitable for enhanced playback.
/// </summary>
public interface IMetadataProcessingPipeline
{
    /// <summary>
    /// Runs all registered processors over the provided raw metadata file and
    ...
    /// or null if no processors are registered.
    /// </returns>
    ...
    /// <summary>
    /// Runs all registered processors over the provided raw metadata file, saves the refined
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>
    /// The path of the saved refined metadata file, or null if no processors are registered.
    /// </returns>
