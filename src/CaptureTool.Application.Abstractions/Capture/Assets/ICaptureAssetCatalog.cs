...
public sealed record CaptureRegistration(CaptureAsset Asset, long Sequence, Guid? AutomaticAuthorization);
...
public interface ICaptureAssetCatalog
{
    ...
    Task RegisterForAnalysisAsync(CaptureAsset asset, Guid? automaticAuthorization, CancellationToken cancellationToken = default);
