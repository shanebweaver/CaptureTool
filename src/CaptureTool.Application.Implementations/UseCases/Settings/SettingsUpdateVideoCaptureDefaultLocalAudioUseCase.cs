...
public sealed partial class SettingsUpdateVideoCaptureDefaultLocalAudioUseCase : AsyncUseCase<bool>, ISettingsUpdateVideoCaptureDefaultLocalAudioUseCase
{
    private readonly ISettingsService _settingsService;

    public SettingsUpdateVideoCaptureDefaultLocalAudioUseCase(ISettingsService settingsService)
    {
