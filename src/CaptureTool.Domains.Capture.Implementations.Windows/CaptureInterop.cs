...
internal static partial class CaptureInterop
{
    ...
    /// </summary>
    /// <param name="pFrameData">Pointer to VideoFrameData structure.</param>
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    internal delegate void VideoFrameCallback(ref VideoFrameData frameData);

    /// <summary>
    /// Delegate for audio sample callback from native layer.
    /// </summary>
    /// <param name="pSampleData">Pointer to AudioSampleData structure.</param>
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    internal delegate void AudioSampleCallback(ref AudioSampleData sampleData);
