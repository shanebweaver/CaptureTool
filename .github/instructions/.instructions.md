...
- **Presentation.Windows.WinUI**: WinUI 3 presentation layer for Windows platform
...
6. Update Presentation.Windows.WinUI if new UI elements are needed
...
5. Wire up in ViewModels and Presentation layer
