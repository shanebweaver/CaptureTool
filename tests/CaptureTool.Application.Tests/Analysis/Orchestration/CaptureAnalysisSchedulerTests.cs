...
public sealed class CaptureAnalysisSchedulerTests
{
    ...
    private sealed class RecordingJobStore : ICaptureAnalysisJobStore
    {
        ...
        public ValueTask<CaptureAnalysisJobMutationResult> TryWaitForCapabilityAsync(CaptureAnalysisJobLeaseToken leaseToken, AnalysisFailure? reason, CancellationToken cancellationToken = default) => throw new NotSupportedException();
